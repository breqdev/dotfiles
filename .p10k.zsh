# Generated by Powerlevel10k configuration wizard on 2022-05-31 at 18:30 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%226F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%226F\uE0B3'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=206
  # Custom icon.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%203F'  # yellow foreground
      local  untracked='%203F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=39
  # Custom icon.
